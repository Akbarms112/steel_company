      ...
      <section className="bg-gray-900 py-14 text-white text-center relative overflow-hidden mb-12">
        <div className="max-w-4xl mx-auto px-4 space-y-3 relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl font-black uppercase tracking-tight font-heading">
            REQUEST A <span className="text-amber-400">QUOTATION</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
          {[
            ...
            <ThreeDScrollReveal key={idx} delay={idx * 0.1}>
              <div className="p-5 rounded-2xl bg-gray-50 border border-gray-100 hover:border-amber-400 hover:shadow-lg transition-all card-hover relative overflow-hidden">
                <span className="text-4xl font-black text-gray-200 absolute top-2 right-3 select-none">
                  {item.step}
                </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 bg-white border border-gray-200 rounded-3xl p-6 sm:p-8 shadow-xl">
            ...
            {submitted && (
              <div className="p-4 mb-6 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs flex items-center gap-3">
            ...
            <form onSubmit={handleWhatsAppSend} className="space-y-5 text-sm">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 text-gray-900 focus:outline-none focus:border-gray-900 focus:ring-2 focus:ring-gray-200 text-sm transition-all"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  <label className="block text-xs font-extrabold text-gray-700 uppercase tracking-wider mb-2">
                    Estimated Quantity <span className="text-amber-500">*</span>
                  </label>
                  <input
                    type="text"
                    name="quantity"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 text-gray-900 focus:outline-none focus:border-gray-900 focus:ring-2 focus:ring-gray-200 text-sm transition-all resize-none"
                ></textarea>
              </div>
              ...
              <div className="pt-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button
                  type="submit"
                  className="py-3.5 px-6 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-xs uppercase tracking-wider shadow-lg flex items-center justify-center gap-2 transition-all"
                >
                ...
                <button
                  ...
                  className="py-3.5 px-6 rounded-xl bg-gray-900 hover:bg-gray-800 text-white font-extrabold text-xs uppercase tracking-wider shadow-lg transition-all"
                >
                  Submit Form
                </button>
              </div>
            ...
            <ThreeDTiltCard depth={50}>
              <div className="bg-gray-900 text-white rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl border border-gray-800">
                <div className="flex items-center justify-between border-b border-gray-800 pb-4">
                  ...
                  <span className="text-[11px] font-mono text-gray-400">BAGAVAN STEELS</span>
                </div>

                <div className="space-y-4 text-xs">
                  <div>
                    <span className="text-gray-400 uppercase tracking-wider block">Customer Name</span>
                    <p className="text-sm font-bold text-white mt-0.5">{formData.name || 'Your Name'}</p>
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <span className="text-gray-400 uppercase tracking-wider block">Contact Phone</span>
                      <p className="text-sm font-bold text-amber-400 mt-0.5">{formData.phone || 'Phone Number'}</p>
                    </div>
                    <div>
                      <span className="text-gray-400 uppercase tracking-wider block">Target Location</span>
                      <p className="text-sm font-bold text-white mt-0.5">{formData.location || 'Dharmapuri'}</p>
                    </div>
                  </div>

                  <div>
                    <span className="text-gray-400 uppercase tracking-wider block">Selected Product</span>
                    <p className="text-sm font-bold text-amber-300 mt-0.5">{formData.product}</p>
                  </div>

                  <div>
                    <span className="text-gray-400 uppercase tracking-wider block">Quantity</span>
                    <p className="text-sm font-bold text-white mt-0.5">{formData.quantity}</p>
                  </div>

                  <div className="p-3 rounded-xl bg-gray-800/80 border border-gray-700 text-gray-300 space-y-1">
                    <span className="text-[10px] text-amber-400 font-bold uppercase block">Requirement Details</span>
